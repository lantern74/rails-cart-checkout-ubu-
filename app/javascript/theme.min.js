...
document.addEventListener("DOMContentLoaded", function () {
  ...
  //weirdly enough  this \/ code below works when you load the page 1st time... and the turbolinks code which start on the line 30 works from the second time, so I need to keep both. If you turn off either one it will stop working
  $(".popup-settings-edit-funnel").length &&
    $(".popup-settings-edit-funnel").magnificPopup({
      type: "inline",
      mainClass: "mfp-fade",
      removalDelay: 160,
      preloader: !1,
...
//looks like the problem is that popups have to be initializied twice because if I use turbolinks sometimes it doesn't work
