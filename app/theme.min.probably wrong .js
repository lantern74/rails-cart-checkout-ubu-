  ...
  !(function () {
    ...
    $(".course-list").length &&
      ...
      $("input[name=tags]").length &&
        ((e = document.querySelector("input[name=tags]")), new Tagify(e)),
      $(".headingTyped").length &&
    ...
    tippy(".imgtooltip", {
      content: function (e) {
        e = e.getAttribute("data-template");
    ...
    tippy(".covinfo", {
      content:
        "Pomocník udává, že má za sebou alespoň 1. dávku vakcíny a je ochotna doložit vakcinační certifikát",
      animation: "scale",
    }),
    tippy(".osobinfo", {
      content:
        "Naše ověření kde si s pomocníkem povídáme, ověříme OP a rejstřík trestů",
      animation: "scale",
    }),
    tippy(".vidinfo", {
      content: "Naše ověření kde si s pomocníkem povídáme a ověříme přes video",
      animation: "scale",
    }),
    tippy(".myidinfo", {
      content:
        "Ukazuje 3 stupně ověření přes mojeID. Pomocník si může ověřit email, adresu a identitu. Počet oranžových štítů vám  ukáže, na jakém je stupni.",
      animation: "scale",
    }),
    tippy(".bookmark", {
      content: "Místo",
    ...
    tippy(".city", {
      content: "Místo kde je nejčastěji",
      animation: "scale",
    }),
